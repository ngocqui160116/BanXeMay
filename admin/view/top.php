  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="../qlsanpham/">Quản lý xe</a></li>
        <li><a href="../qlloaixe/">Quản lý loại xe</a></li>
        <li><a href="../qlthuonghieu/">Quản lý thương hiệu</a></li>
        <li><a href="">Khác...</a></li>        
      </ul>
    </div>
  </div>
  ...
  <div class="row content">
    ...
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="../qlsanpham"><span class="glyphicon glyphicon-list-alt"></span> Quản lý xe</a></li>
        <li><a href="../qlloaixe"><span class="glyphicon glyphicon-gift"></span> Quản lý loại xe</a></li>
...
<!-- Form cap nhat ho so -->
<div id="fcapnhathoso" role="dialog" class="modal fade">
	<div class="modal-dialog">
		 ...
		 <div class="text-center">
			 <img class="img-circle" src="../images/<?php if($_SESSION["nguoidung"]["hinhanh"]==NULL)
				 echo "user.png";
			 else
		 ...
		 <div class="form-group"> 
			...
			value="<?php echo $_SESSION["nguoidung"]["sodienthoai"]; ?>">		
		 </div> 
		 <div class="form-group">
			 <label>Họ tên</label>
			 <input class="form-control" type="text" name="txthoten"
			value="<?php echo $_SESSION["nguoidung"]["hoten"]; ?>"
			required>
		</div>
		 <div class="form-group">
...
<div id="fdoimatkhau" role="dialog" class="modal fade">
	<div class="modal-dialog">
		 <div class="modal-content">
			 <div class="modal-header">
				 <button type="button" class="close" data-dismiss="modal">&times;</button>
