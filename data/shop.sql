...
CREATE DATABASE IF NOT EXISTS `testtwo` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `testtwo`;
...
INSERT INTO `dm` (`id`, `tendanhmuc`) VALUES
(1, 'Adidas'),
(2, 'Puma'),
(3, 'Nike');
...
INSERT INTO `dc` (`id`, `nguoidung_id`, `diachi`, `macdinh`) VALUES
...
INSERT INTO `dh` (`id`, `nguoidung_id`, `diachi_id`, `ngay`, `tongtien`, `ghichu`) VALUES
...
INSERT INTO `dhct` (`id`, `donhang_id`, `mathang_id`, `dongia`, `soluong`, `thanhtien`) VALUES
...
INSERT INTO `mh` (`id`, `tenmathang`, `mota`, `giagoc`, `giaban`, `soluongton`, `hinhanh`, `danhmuc_id`, `luotxem`, `luotmua`) VALUES
...
INSERT INTO `nd` (`id`, `email`, `sodienthoai`, `matkhau`, `hoten`, `loai`, `trangthai`, `hinhanh`) VALUES
